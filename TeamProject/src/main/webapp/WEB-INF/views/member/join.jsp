...
<div id="join-form-wrap">
  ...
  <div id ="form-div" >
    <br><p>이메일 주소<br>
    <input type="text" id="member_mail" name="member_mail" placeholder="이메일을 입력해주세요" required>
    <input style="width:20px; border: none; background-color: white;" id="hi" type="text" placeholder=" @" disabled>  
    <input type="text" id="member_mail" name="member_mail" placeholder="이메일 주소를 입력해주세요" required>
    </p>
    <p>이름<br>
    ...
    <input id="member_address" name="member_address" placeholder="주소" required readonly="readonly"><br>
    <input type="text" id="member_address" name="member_address" placeholder="상세 주소를 입력하세요" required>
    <p>휴대폰 번호<br>
    <input type="text" id="member_phone" name="member_phone" placeholder="휴대폰 번호를 입력해주세요" required>
    </p>
