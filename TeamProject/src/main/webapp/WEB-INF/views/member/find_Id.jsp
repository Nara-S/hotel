...
<div id="id_find_sec_div">
	<span id="id_div2">아이디 찾기</span>
	<div id="id_find_sec_div2">
		<span id="id_div3">아이디를 찾고자하는 휴대폰 번호를 입력해 주세요.</span>
		<div id="id_find_sec_div3">
		
		<form action="" id="form">
		<input type="text" id="find_pw" name="mobile" placeholder="휴대폰 번호를 입력하세요 " required>
		...
		아이디가 기억이 난다면? <a href="<%=request.getContextPath() %>/member/find_pass.jsp">비밀번호 찾기 바로가기</a>
	</div>
</div>		
</section>
<!-- //body -->
