	...
	<div class="sub_wrapper">
		<div class="sub_rf_detail" >
			<div class="sub_rf_main_img">
				<img alt="room_image" src="../images/room_deluxeDouble.jpg">
			</div>
			<div class="sun_btn"><a href="<%=request.getContextPath() %>/sub/reservation.jsp">RESERVATION</a></div>
			<h2>ROOM FEATURE</h2>
		...
		<div class="sun_btn" style="margin-top: 50px;"><a href="<%=request.getContextPath() %>/sub/rooms.jsp">LIST</a></div>
	</div>
</div>
<!-- //body -->
