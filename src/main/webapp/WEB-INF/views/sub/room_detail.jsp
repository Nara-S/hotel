	...
	<div class="sub_wrapper">
		<div class="sub_rf_detail" >
			<div class="sub_rf_main_img">
				<img alt="room_image" src="${pageContext.request.contextPath}/resources/images/room_deluxeDouble.jpg">
			</div>
			<div class="sun_btn"><a href="${pageContext.request.contextPath}/sub/reservation">RESERVATION</a></div>
			<h2>ROOM FEATURE</h2>
		...
		<div class="sun_btn" style="margin-top: 50px;"><a href="${pageContext.request.contextPath}/sub/rooms.jsp">LIST</a></div>
	</div>
</div>
<!-- //body -->
