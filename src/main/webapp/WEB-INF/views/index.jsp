          ...
          <div class="col-md-7">
            <div class="media d-block room mb-0">
              ...
              <div class="media-body">
                <h3 class="mt-0"><a href="${pageContext.request.contextPath}/sub/room_detail.jsp">Standard Room</a></h3>
                <ul class="room-specs">
                ...
                <p><a href="${pageContext.request.contextPath}/sub/room_detail.jsp" class="btn btn-primary btn-sm">RESERVATION</a></p>
              </div>
            </div>
          </div>
          <div class="col-md-5 room-thumbnail-absolute">
            <a href="${pageContext.request.contextPath}/sub/room_detail.jsp" class="media d-block room bg first-room" style="background-image: url(${pageContext.request.contextPath}/resources/images/main03_room02.png); ">
              <!-- <figure> -->
                <div class="overlap-text">
                  <span>
                    DELUXE ROOM
            ...
            <a href="${pageContext.request.contextPath}/sub/room_detail.jsp" class="media d-block room bg second-room" style="background-image: url(${pageContext.request.contextPath}/resources/images/main03_room03.png); ">
              <!-- <figure> -->
                <div class="overlap-text">
                  <span>
                    DELUXE ROOM
        ...
        <div class="row ">
          <div class="col-md-4">
            <div class="post-entry">
              ...
              <div class="body-text">
                ...
                <h3 class="mb-3"><a href="${pageContext.request.contextPath}/sub/facilities_detail.jsp">Meeting</a></h3>
                <p class="mb-4">
					비즈니스 미팅에 적합한 형태로, 소규모 세미나 및<br>
					연회, 가족모임 등 수월한 행사 진행이 가능합니다.
				</p>
                <p><a href="${pageContext.request.contextPath}/sub/facilities_detail.jsp" class="btn btn-primary btn-outline-primary btn-sm">Read More</a></p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="post-entry">
              ...
              <div class="body-text">
                <div class="category">Facilities</div>
                <h3 class="mb-3"><a href="${pageContext.request.contextPath}/sub/facilities_detail.jsp">Flower Shop</a></h3>
                <p class="mb-4">
          ...
          <div class="col-md-4">
            <div class="post-entry">
              ...
              <div class="body-text">
                <div class="category">Facilities</div>
                <h3 class="mb-3"><a href="${pageContext.request.contextPath}/sub/facilities_detail.jsp">Wedding</a></h3>
                <p class="mb-4">
