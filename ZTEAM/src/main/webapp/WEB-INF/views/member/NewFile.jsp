...
<div id="join-form-wrap">
  ...
  <div id ="form-div" >
   ...
   <input type="button" id="member_id_check" class="zip_search" value="ID 중복 체크">  
    ...
    <p>생년월일<br>
    <input type="text" id="member_year" name="member_year" placeholder="년(4자)">
    
   <select id="member_month" name="member_month" size="1">
   ...
   <input type="text" id="member_day" name="member_day" placeholder="일">
   </p>
     <p>성별<br>
     <input type="radio" id="gender1" name="gender" value="male" / >남성
     <input type="radio" id="gender2" name="gender" value="female" / >여성<br>
    <br><p>이메일 주소<br>
    ...
    <input type="text" id="email2" name="email2" placeholder="이메일 주소를 입력해주세요" required>
     ...
     <label>주소</label><br> <input type="text" id="sample4_postcode"  class="zipcode"  name = "address1" placeholder="우편번호" readonly required>
<input type="button" onclick="sample4_execDaumPostcode()" class="zip_search"  value="우편번호 찾기" ><br>
<label></label><input type="text" id="sample4_roadAddress" name = "address2" placeholder="도로명주소" readonly required><br>
